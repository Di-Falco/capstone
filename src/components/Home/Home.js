...
function Home() {
  return(
    <React.Fragment>
      ...
      <div className="menu">
        <h4>------------- MENU -------------</h4>
        <h4><a href="/"><button className="menu-btn">HOME</button></a>&emsp;<a href="/account"><button className="menu-btn">ACCOUNT</button></a>&emsp;<a href="https://github.com/Di-Falco/capstone"><button className="menu-btn">INFO</button></a></h4>
